...
const App: React.FC = () => {
  return (
    <div className="max-w-[43em] mx-auto text-[1.2em] leading-normal text-black pb-10">
      ...
      {/* Welcome Section */}
      <Section title="Welcome to Milady vrom Back! — ゆっくりしていってね!" variant="default">
        <p className="m-2 ml-4">
          Milady vrom Back is a collection of 3,333 generative pfpNFTs in a neochibi aesthetic inspired by street style tribes—not all of them want to show their backs.
        </p>
      </Section>

      {/* Social Links */}
      <p className="text-center m-2">
        <a href="https://discord.gg/milady" className="text-blue-700 underline hover:text-red-600">Milady vrom Back Village Community Discord</a> |{' '}
        <a href="https://twitter.com/kafeosas" target="_blank" rel="noreferrer" className="text-blue-700 underline hover:text-red-600">Milady vrom Back Official Twitter</a>
      </p>

      {/* Collection Section */}
      <Section title="Milady vrom Back Collection" variant="light">
        <br />
        ...
        <p className="text-center m-2">
          ...
          <a href="https://opensea.io/collection/backmilady" className="text-blue-700 underline hover:text-red-600">
            You can view and trade the Milady vrom Back collection on the secondary market at OpenSea.
          </a>
        </p>
      </Section>
      ...
      {/* What is Section */}
      <Section title="What is Milady vrom Back?" variant="light">
        <p className="m-2 ml-4">
          Milady vrom Back reimagines the original Back Milady ethos with a fresh spatial twist—characters emerging "vrom the back," evoking mysterious arrivals vrom hidden urban alleys or shadowy Tokyo subculture scenes, perfectly aligning with Y2K Japanese fashion tribes like Gyaru and Harajuku.
        </p>
      </Section>
      ...
      <div className="p-4 px-12">
        <div className="border border-black p-4 italic text-center bg-white/50">
          ...
          <p className="mt-2 text-center">
            Milady vrom Back style is inspired by the subcultural fashion tribes of Y2K Japan.
          </p>
        </div>
      </div>
      ...
      <Section title="Lifestyle Experiences" variant="light" id="lifestyle_experiences">
        <p className="m-2 ml-4">
          Milady vrom Back is an aesthetic, a lifestyle and a community. We are constantly
          conceptualizing and developing social extensions of the Milady vrom Back vision.
        </p>
        <hr className="border-gray-300 my-4" />

        <p className="m-2 ml-4">
          <b>Milady vrom Back VRtube:</b> Miladies were designed as separate asset layers, so
          they are readymade for Live2D rigging for use as VRtube avatars. We've rolled out Milady vrom Back VTube avatars in collaboration with Hologram Labs. Just connect your wallet with <a href="https://www.hologram.xyz/" className="text-blue-700 underline hover:text-red-600">the Hologram app</a> to use any Milady vrom Back in streams or videocall.
        </p>
        <div className="p-4 px-12">
        ...
        <p className="m-2 ml-4">
          <b>Milady vrom Back Raves:</b> Holder meetups in the vrom of warehouse raves put on in major cities like NYC, London, Tokyo in collaboration with their local underground scenes.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
        ...
        <p className="m-2 ml-4">
          ...
          knockoffs of designer cosmetic series with logos detourned to feature Milady vrom Back graphics.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
        ...
        <p className="m-2 ml-4">
          <b>Milady vrom Back Minecraft Metaverse:</b> Highly customized Minecraft server exclusive to the Milady vrom Back community, featuring NFT-gated land plots and regular community events. Join by entering milady.world in Minecraft after authenticating in <a href="discord.gg/milady" className="text-blue-700 underline hover:text-red-600">Milady vrom Back Village discord</a>.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
            <ImageFrame src="https://thumbs4.imagebam.com/81/0a/57/ME18NN6Y_t.gif" className="!my-0" />
            <p className="mt-2 text-center">
              <a href="https://discord.gg/milady" className="text-blue-700 underline hover:text-red-600">Join Milady vrom Back Village</a>
            </p>
          </div>
        </div>
      </Section>
      ...
      <div className="p-4 px-12">
        <div className="border border-black p-4 italic text-center bg-white/50">
          ...
          <p className="mt-2 text-center">
            Milady vrom Back produces eclectic but spiritually coherent outfits.
          </p>
        </div>
      </div>
      ...
      <Section title="Expansion Packs" variant="light" id="expansion_packs">
        <p className="m-2 ml-4">
          As a <a href="https://viralpubliclicense.org" className="text-blue-700 underline hover:text-red-600">copylefted</a> brand, Milady vrom Back supports a thriving ecosystem of derivative projects vrom its fan community.
          Remilia Collective also produces official expansions given away to Milady vrom Back holders following our <a href="https://goldenlight.mirror.xyz/qhsg6I_zn8o40B_Roo9Owabc_9dwAnlxFMADHM3D-Qk" className="text-blue-700 underline hover:text-red-600">hypercitational method</a>.
        </p>
        <hr className="border-gray-300 my-4" />
        
        <p className="m-2 ml-4">
          <b>Banners NFT:</b> Generative NFT header photo series, a free mint offered to Milady vrom Back holders, made in collaboration with the community's submitted captions.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
        ...
        <p className="m-2 ml-4">
          <b>Redacted Remilio Babies:</b> Companion collection to Milady vrom Back, as the canonical zoomer little brother to Milady. Where Milady vrom Back explores Japanese style tribes, Remilio uses the neochibi pfp framework to engage reactionary, schizophrenic and zoomer aesthetics.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
        ...
        <p className="m-2 ml-4">
          <b>Milady vrom Back, That B.I.T.C.H.:</b> Surprise free mint offered directly vrom contract, featuring Milady vrom Back in a bootleg english t-shirt each spelling out B-I-T-C-H with random words.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
          ...
          <p className="m-2 ml-4">
            Words used for the random generation were sourced vrom cultural critic Angelicism01's essay on Milady,
        ...
        <p className="m-2 ml-4">
          <b>Pixelady Maker:</b> Pixel art derivative heavily referencing wider Milady vrom Back memes and culture and general extremely online internet aesthetics, lead by <a href="https://twitter.com/egrevore" className="text-blue-700 underline hover:text-red-600">Egrevore</a> with art by <a href="https://twitter.com/MRYOKOU" className="text-blue-700 underline hover:text-red-600">Mr. Yokou</a>.
        </p>
        <div className="p-4 px-12">
          <div className="p-4 italic text-center">
      ...
      <ul className="list-disc ml-8 mr-4 space-y-1">
        <li>
          <b>Avatar-first design:</b> Illustrated vrom the beginning to ensure
        ...
        <li>
          <b>Graded for Drip:</b> Milady vrom Back have ranked badges on a <a href="#drip_grade" className="text-blue-700 underline hover:text-red-600">variety of weighted metrics</a>, adding additional
        ...
        <li>
          <b>Milady vrom Back Village:</b> Highly curated Discord community and designated
          launchpad for <a href="#expansion_packs" className="text-blue-700 underline hover:text-red-600">expansions to the Milady vrom Back project</a>, such as
          virtual Milady vrom Back raves and event nights.
        </li>
      </ul>
      ...
      <Section title="Style Themes" variant="light">
        <p className="m-2 ml-4">
          Milady vrom Back generate a variety of accessories, but the two primary
        ...
        <hr className="border-gray-300 my-4" />
        <p className="m-2 ml-4">
          The bottom border of a Milady vrom Back card is defined by its theme(s). A
          Milady vrom Back whose Hat & Shirt cosmetic share the same theme receives +5 on
      ...
      <Section title="Drip Grade" variant="light" id="drip_grade">
        <p className="m-2 ml-4">
          Milady vrom Back each have a drip score rating their overall stylishness, with
        ...
        <p className="m-2 ml-4">
          Milady vrom Back are given a letter grading for their drip score (D, C, B, A, S,
          SS) to help categorize an individual Milady vrom Back quality.
        </p>
      </Section>
      ...
      <div className="p-4 px-12">
        <div className="border border-black p-4 italic text-center bg-white/50">
          ...
          <p className="mt-2 text-center">We love a cute Milady vrom Back!</p>
        </div>
      </div>

      {/* About Section */}
      <Section title="About Milady vrom Back — プリンセスメーカーについて" variant="red">
        <div className="text-center">
          <p className="m-2">
            Milady vrom Back is a <a href="https://remilia.org" target="_blank" rel="noreferrer" className="text-blue-700 underline hover:text-red-600">Remilia Collective</a> project. 
          ...
          <hr className="border-gray-400 my-4" />
          <p className="m-2">
            All Milady vrom Back branding, assets and NFTs are copylefted under the <a href="https://viralpubliclicense.org" className="text-blue-700 underline hover:text-red-600">Viral Public License</a>.
          </p>
        </div>
      </Section>
      ...
      <Section title="Authorship Hash — 著者名ハッシュ" variant="red">
        ...
        <p className="font-mono ml-4 text-[1em]">
          ...
          Milady vrom Back is an original remix of the character "<a href="https://bottlefairy.fandom.com/wiki/Hororo" className="text-blue-700 underline hover:text-red-600">Hororo</a>" vrom <a href="https://en.wikipedia.org/wiki/Bottle_Fairy" className="text-blue-700 underline hover:text-red-600">Bottle Fairy (2003)</a>, with:
